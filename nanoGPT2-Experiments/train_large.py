...
ema_decay = 0.9000
out_dir = '/scratch/07946/ss95332/large/out'
out_dir_ema = '/scratch/07946/ss95332/large/out_ema_70k'
eval_interval = 1000
log_interval = 1
...
batch_size = 2  # if gradient_accumulation_steps > 1, this is the micro-batch size, was 12 earlier
block_size = 1024
# model
n_layer = 36
n_head = 20
...
learning_rate = 2e-3  # max learning rate, earlier it was 6e-4
...
while True:
    ...
    if iter_num % eval_interval == 0 and master_process:
        ...
        with open("logs/large/train3-log/training_val.txt", "a") as log_file:
    ...
    if iter_num % log_interval == 0 and master_process:
        ...
        with open("logs/large/train3-log/training_log.txt", "a") as log_file:
